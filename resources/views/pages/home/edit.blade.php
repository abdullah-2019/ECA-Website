            ...
            <div class="container-fluid">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title">Edit ({{ $home->title }})</h3>
                    ...
                    <form  action="{{ route('home.update',$home->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a class="btn btn-dark btn-sm" href="{{ route('home.list') }}"><i class="fa fa-arrow-left"></i> Back</a>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{ $home->title }}" class="form-control @error('title') is-invalid @enderror"
                                       id="inputName"
                                       placeholder="Title">
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-text text-danger">{{ $message }}</div>
                                @enderror
                                <img src="{{ asset($home->image) }}" width="300px">
